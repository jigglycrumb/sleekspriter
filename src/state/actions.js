...
export const layerDelete = (frame, layer, allPixels) => ({ type: "LAYER_DELETE", frame, layer, allPixels });
export const layerMerge = (frame, first, second, allPixels) => ({ type: "LAYER_MERGE", frame, first, second, allPixels });
...
export const pixelsCut = (frame, layer, pixels, allPixels) => ({ type: "PIXELS_CUT", frame, layer, pixels, allPixels });
export const pixelsDelete = (frame, layer, pixels, allPixels) => ({ type: "PIXELS_DELETE", frame, layer, pixels, allPixels });
...
export const pixelsMove = (frame, layer, pixels, distance, size) => ({ type: "PIXELS_MOVE", frame, layer, pixels, distance, size });
