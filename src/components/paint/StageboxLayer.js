...
class StageboxLayer extends React.Component {
  render() {
    const
      htmlId  = `StageBoxLayer-${this.props.layer.id}`,
    ...
    return (
      <div id={htmlId} className="Layer" style={style}>
        <LayerCanvas ref="layerCanvas" frame={this.props.layer.frame} layer={this.props.layer.id} size={this.props.size} zoom={this.props.zoom} pixels={this.props.pixels} />
      </div>
    );
  }
}
