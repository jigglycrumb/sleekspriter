...
export const layerDelete = (frame, layer) => ({ type: "LAYER_DELETE", frame, layer });
export const layerMerge = (frame, first, second) => ({ type: "LAYER_MERGE", frame, first, second });
...
export const pixelsCut = (frame, layer, pixels, selection) => ({ type: "PIXELS_CUT", frame, layer, pixels, selection });
