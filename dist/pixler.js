    ...
    return (
      React.DOM.div( {id:"FrameBox", className:"box"}, 
        ...
        React.DOM.div( {className:"foldable-fold"}, 
          React.DOM.div( {id:"FrameBoxFrames", style:containerStyle}, 
          frames.map(function(frame) {
            ...
            return (
              React.DOM.div( {key:id, className:classes, style:frameStyle, onClick:clickHandler}, 
                FrameBoxFrame(
                  {id:frame,
                  width:this.props.editor.file.size.width,
                  height:this.props.editor.file.size.height,
...
var PreviewBoxPreview = React.createClass({displayName: 'PreviewBoxPreview',
  ...
  render: function() {
    ...
    return (
      React.DOM.canvas( {id:"PreviewBoxPreview", width:width, height:height})
    );
  }
});
/** @jsx React.DOM */
