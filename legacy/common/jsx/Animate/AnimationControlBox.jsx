  ...
  render: function() {
    ...
    return (
      <div id="AnimationControlBox" className="bar">
        <div>
          <button className={listButtonClasses} onClick={this.handleClick.bind(this, this.props.toggleAnimationList)} onTouchStart={this.handleTouch.bind(this, this.props.toggleAnimationList)} title="Animation list">
        ...
        <div>
          <button className={controlButtonClasses} title="Select previous frame" onClick={this.handleClick.bind(this, this.selectPreviousFrame)} onTouchStart={this.handleTouch.bind(this, this.selectPreviousFrame)}  disabled={controlsDisabled}>
            <i className="flaticon-previous2"/>
          </button>
          <button className={controlButtonClasses} title="Play animation" onClick={this.handleClick.bind(this, this.playAnimation)} onTouchStart={this.handleTouch.bind(this, this.playAnimation)}  disabled={controlsDisabled} style={playButtonStyle}>
            <i className="flaticon-play87"/>
          </button>
          <button className={controlButtonClasses} title="Pause animation" onClick={this.handleClick.bind(this, this.pauseAnimation)} onTouchStart={this.handleTouch.bind(this, this.pauseAnimation)}  disabled={controlsDisabled} style={pauseButtonStyle}>
            <i className="flaticon-small38"/>
          </button>
          <button className={controlButtonClasses} title="Select next frame" onClick={this.handleClick.bind(this, this.selectNextFrame)} onTouchStart={this.handleTouch.bind(this, this.selectNextFrame)}  disabled={controlsDisabled}>
